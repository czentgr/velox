...
class DestinationBuffer {
 public:
  ...
  //  void enqueue(std::shared_ptr<SerializedPage> newData);
  void enqueue(
 ...
 private:
  ...
  folly::Synchronized<std::vector<std::shared_ptr<SerializedPage>>> data_;
...
class OutputBuffer {
 ...
 private:
  ...
  void enqueueBroadcastOutput(std::unique_ptr<SerializedPage> data);

  void enqueueArbitraryOutput(std::unique_ptr<SerializedPage> data);
